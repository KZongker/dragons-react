        ...
        <div className="row justify-content-center">
            ...
            <form id="#formfont">
                ...
                <div className="input-group mb-4">
                    ...
                    <Form.Control type="text" id="name" className="form-control taller" name="name" placeholder="firstname" required />
                </div>
                </Form.Group>
                ...
                <select id="species" name="species" className="form-select mb-4 taller">
